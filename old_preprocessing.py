...
class GraphDataset():
    ...
    def __init__(self, adjacency_matrix_type="None", label_column="In-Group"):
        ...
        if not os.path.exists("2024_08_SCHEMA_A1_embeddings_exp1.npy"):
            ...
            self.embeddings = self.calc_embeddings(
                "dangvantuan/french-document-embedding")
            np.save("2024_08_SCHEMA_A1_embeddings_exp1.npy", self.embeddings)
        else:
            print("Loading Embeddings\n")
            self.embeddings = np.load("2024_08_SCHEMA_A1_embeddings_exp1.npy")
