...
class ExperimentParameters:
    """
    Loads a CSV file and assigns the headers as instance attribute names,
    with the values being from the exp_nb-th row of the CSV file.
    exp_nb is matched from the 'exp_nb' column, not by row index.
    """
    def __init__(self, exp_nb: int) -> None:
        csv_path = "/home/dimitra/Documents/Github/ARENAS-Context-Aware-Graph-Structure-Learning-ContextGSL-/src/experiment_params.csv"
